...
class WrValuePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (wrValueData.containsKey(style.wrStyle.shortPeriod)) {
      x = paintLabel(canvas, size, 0, "WR(${style.wrStyle.shortPeriod}):" +
