...
class UIWidgetPainter extends CustomPainter {
  ...
  bool shouldRepaint(UIWidgetPainter oldUIPainter) {
    return this.range?.minIndex != oldUIPainter.range?.minIndex ||
        this.range?.maxIndex != oldUIPainter.range?.maxIndex;
  }


  @override
  bool shouldRebuildSemantics(UIWidgetPainter oldDelegate) {
    return false;
  }
}
...
class _UIWidgetState extends State<UIWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomPaint(
      painter:
          UIWidgetPainter(widget.uiCamera, widget.uiPainterData, this.range),
    );
  }
